...
var damage_taken;
if (global.currentsuit == 0 || argument3 == 1) damage_taken = argument0 * ((global.difficulty == 2) + 1);
if (argument3 == 0) {
    if (global.currentsuit == 1) damage_taken = ceil(argument0 * 0.5) * ((global.difficulty == 2) + 1);
    if (global.currentsuit == 2) damage_taken = ceil(argument0 * 0.25) * ((global.difficulty == 2) + 1);
}
