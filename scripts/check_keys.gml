...
if (gamepad_is_supported()) {
    if (gamepad_is_connected(0) && global.opxjoyenable) {
        if (global.opxjoyvib) gamepad_set_vibration(0, global.vibL, global.vibR);
        xjoyx = gamepad_axis_value(0, gp_axislh);
        xjoyy = gamepad_axis_value(0, gp_axislv);
        ...
        if (ctrl_Left == 0 && ctrl_Right == false && gamepad_button_check(0, gp_padl)) {
            ctrl_Left = 1;
            global.controltype = 2;
            walk_zone = 0;
        }
        if (ctrl_Left == 0 && ctrl_Right == false && gamepad_button_check(0, gp_padr)) {
            ctrl_Right = 1;
            global.controltype = 2;
            walk_zone = 0;
        }
        if (ctrl_Up == 0 && ctrl_Down == false && gamepad_button_check(0, gp_padu)) {
            ctrl_Up = 1;
            global.controltype = 2;
            walk_zone = 0;
        }
        if (ctrl_Up == 0 && ctrl_Down == false && gamepad_button_check(0, gp_padd)) {
            ctrl_Down = 1;
            global.controltype = 2;
            walk_zone = 0;
        }
        if (ctrl_A == false && gamepad_button_check(0, global.opxjoybtn_a)) {
            ctrl_A = 1;
            global.controltype = 2;
        }
        if (ctrl_B == false && gamepad_button_check(0, global.opxjoybtn_b)) {
            ctrl_B = 1;
            global.controltype = 2;
        }
        if (ctrl_X == false && gamepad_button_check(0, global.opxjoybtn_x)) {
            ctrl_X = 1;
            global.controltype = 2;
        }
        if (ctrl_L == false && gamepad_button_check(0, global.opxjoybtn_l)) {
            ctrl_L = 1;
            global.controltype = 2;
        }
        if (global.opaimstyle == 1 && ctrl_L2 == false && gamepad_button_check(0, global.opxjoybtn_l2)) {
            ctrl_L2 = 1;
            global.controltype = 2;
        }
        if (ctrl_R == false && gamepad_button_check(0, global.opxjoybtn_r)) {
            ctrl_R = 1;
            global.controltype = 2;
        }
        if (ctrl_R2 == false && gamepad_button_check(0, global.opxjoybtn_r2)) {
            ctrl_R2 = 1;
            global.controltype = 2;
        }
        if (ctrl_Select == false && gamepad_button_check(0, global.opxjoybtn_sel)) {
            ctrl_Select = 1;
            global.controltype = 2;
        }
        if (ctrl_Start == false && gamepad_button_check(0, global.opxjoybtn_str)) {
            ctrl_Start = 1;
            global.controltype = 2;
        }
        if (ctrl_Exit == false && gamepad_button_check(0, global.opxjoybtn_exit)) {
            ctrl_Exit = 1;
            global.controltype = 2;
        }
        if (ctrl_Menu1 == false && gamepad_button_check(0, global.opxjoybtn_menu1)) {
            ctrl_Menu1 = 1;
            global.controltype = 2;
        }
        if (ctrl_Menu2 == false && gamepad_button_check(0, global.opxjoybtn_menu2)) {
            ctrl_Menu2 = 1;
            global.controltype = 2;
        }
    } // if (gamepad_is_connected(0) && global.opxjoyenable)
